...
public class TheTitansNeoSounds {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> TITAN_ZOMBIFIED_PIGLIN_LIVING = SOUNDS.register("titanpigzombieliving", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.tryBuild(TheTitansNeo.MODID, "titanpigzombieliving")));
	public static final DeferredHolder<SoundEvent, SoundEvent> TITAN_ZOMBIFIED_PIGLIN_GRUNT = SOUNDS.register("titanpigzombiegrunt", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.tryBuild(TheTitansNeo.MODID, "titanpigzombiegrunt")));
	public static final DeferredHolder<SoundEvent, SoundEvent> TITAN_ZOMBIFIED_PIGLIN_DEATH = SOUNDS.register("titanpigzombiedeath", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.tryBuild(TheTitansNeo.MODID, "titanpigzombiedeath")));
