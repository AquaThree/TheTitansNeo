...
import net.byAqua3.thetitansneo.render.RenderZombifiedPiglinTitan;
...
import net.byAqua3.thetitansneo.render.minion.RenderZombifiedPiglinTitanMinion;
...
public class TheTitansNeoEntityRenderers {
	...
	public static void onRegisterEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(TheTitansNeoEntities.ZOMBIFIED_PIGLIN_TITAN_MINION.get(), RenderZombifiedPiglinTitanMinion::new);
		...
		event.registerEntityRenderer(TheTitansNeoEntities.ZOMBIFIED_PIGLIN_TITAN.get(), RenderZombifiedPiglinTitan::new);
