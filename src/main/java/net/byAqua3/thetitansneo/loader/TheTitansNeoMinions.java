...
public class TheTitansNeoMinions {
	...
	public static void registerMinions() {
		...
		MINIONS.put("entity.thetitansneo.zombified_piglin_titan", EntityZombifiedPiglinTitanMinion.class);
		MINIONS.put("entity.thetitansneo.zombified_piglin_baby_titan", EntityZombifiedPiglinTitanMinion.class);
		...
		SPECIAL_MINIONS.put("entity.thetitansneo.zombified_piglin_titan", EntityGhastGuardMinion.class);
		SPECIAL_MINIONS.put("entity.thetitansneo.zombified_piglin_baby_titan", EntityGhastGuardMinion.class);
