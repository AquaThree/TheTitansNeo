...
public class TheTitansNeoEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<EntityZombifiedPiglinTitanMinion>> ZOMBIFIED_PIGLIN_TITAN_MINION = ENTITY_TYPES.register("zombified_piglin_titan_minion", () -> EntityType.Builder.<EntityZombifiedPiglinTitanMinion>of(EntityZombifiedPiglinTitanMinion::new, MobCategory.MONSTER).clientTrackingRange(8).sized(0.6F, 1.95F).eyeHeight(1.79F).passengerAttachments(2.0F).ridingOffset(-0.7F).build(ResourceLocation.tryBuild(TheTitansNeo.MODID, "zombified_piglin_titan_minion").toString()));
