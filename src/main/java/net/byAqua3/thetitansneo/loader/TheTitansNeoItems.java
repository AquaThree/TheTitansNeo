...
public class TheTitansNeoItems {
	...
	public static final DeferredHolder<Item, Item> SPAWN_EGG_ZOMBIFIED_PIGLIN_TITAN_MINION = ITEMS.register("spawn_egg_zombified_piglin_titan_minion", () -> new DeferredSpawnEggItem(() -> TheTitansNeoEntities.ZOMBIFIED_PIGLIN_TITAN_MINION.get(), 15373203, 5009705, new Item.Properties()));
	...
	public static final DeferredHolder<Item, Item> SPAWN_EGG_WITHER_SKELETON_TITAN = ITEMS.register("spawn_egg_wither_skeleton_titan", () -> new ItemTitanSpawnEgg(new Item.Properties().rarity(Rarity.UNCOMMON), ResourceLocation.tryBuild(TheTitansNeo.MODID, "skeleton_titan"), 1, TheTitansNeoSpawns.SPAWNED_WITHER_SKELETON_TITAN));
	...
	public static final DeferredHolder<Item, Item> SPAWN_EGG_CHARGED_CREEPER_TITAN = ITEMS.register("spawn_egg_charged_creeper_titan", () -> new ItemTitanSpawnEgg(new Item.Properties().rarity(Rarity.UNCOMMON), ResourceLocation.tryBuild(TheTitansNeo.MODID, "creeper_titan"), 1, TheTitansNeoSpawns.SPAWNED_CHARGED_CREEPER_TITAN));
	...
	public static final DeferredHolder<Item, Item> SPAWN_EGG_SPIDER_JOCKEY_TITAN = ITEMS.register("spawn_egg_spider_jockey_titan", () -> new ItemTitanSpawnEgg(new Item.Properties().rarity(Rarity.UNCOMMON), ResourceLocation.tryBuild(TheTitansNeo.MODID, "spider_titan"), 1, TheTitansNeoSpawns.SPAWNED_SPIDER_JOCKEY_TITAN));
	public static final DeferredHolder<Item, Item> SPAWN_EGG_ZOMBIFIED_PIGLIN_TITAN = ITEMS.register("spawn_egg_zombified_piglin_titan", () -> new ItemTitanSpawnEgg(new Item.Properties().rarity(Rarity.UNCOMMON), ResourceLocation.tryBuild(TheTitansNeo.MODID, "zombified_piglin_titan")));
	...
	public static void registerItemRenderers() {
		...
		ITEMRENDERERS.put(SPAWN_EGG_ZOMBIFIED_PIGLIN_TITAN.get(), new RenderTitanSpawnEgg());
