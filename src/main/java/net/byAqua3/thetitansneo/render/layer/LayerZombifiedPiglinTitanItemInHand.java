...
@OnlyIn(Dist.CLIENT)
public class LayerZombifiedPiglinTitanItemInHand extends RenderLayer<EntityZombifiedPiglinTitan, ModelZombifiedPiglinTitan> {

	public LayerZombifiedPiglinTitanItemInHand(RenderLayerParent<EntityZombifiedPiglinTitan, ModelZombifiedPiglinTitan> renderer) {
		super(renderer);
	}

	@Override
	public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, EntityZombifiedPiglinTitan entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
