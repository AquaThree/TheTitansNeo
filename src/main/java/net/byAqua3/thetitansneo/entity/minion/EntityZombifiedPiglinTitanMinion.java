			...
			if (this.getMaster() == null && this.isAlive()) {
				if (!this.level().isClientSide() && this.level().getDifficulty() != Difficulty.PEACEFUL) {
					...
					if (randomRate < TheTitansNeoConfigs.bishopSummonMinionSpawnRate.get()) {
						...
						zombifiedPiglinTitanMinion.finalizeSpawn((ServerLevelAccessor) this.level(), this.level().getCurrentDifficultyAt(zombifiedPiglinTitanMinion.blockPosition()), MobSpawnType.SPAWNER, new Zombie.ZombieGroupData(false, true));
