...
public class AnimationZombifiedPiglinTitanAntiTitanAttack extends AIAnimation {
	
	private EntityZombifiedPiglinTitan entity;

	public AnimationZombifiedPiglinTitanAntiTitanAttack(EntityZombifiedPiglinTitan entity) {
		super(entity);
		this.entity = entity;
	}
