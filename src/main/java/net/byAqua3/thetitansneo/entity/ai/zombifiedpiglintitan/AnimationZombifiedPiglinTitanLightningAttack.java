...
public class AnimationZombifiedPiglinTitanLightningAttack extends AIAnimation {

	private EntityZombifiedPiglinTitan entity;

	public AnimationZombifiedPiglinTitanLightningAttack(EntityZombifiedPiglinTitan entity) {
		super(entity);
		this.entity = entity;
	}
