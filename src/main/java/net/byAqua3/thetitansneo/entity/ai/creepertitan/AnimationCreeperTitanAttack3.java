...
public class AnimationCreeperTitanAttack3 extends AIAnimation {
	private EntityCreeperTitan entity;

	public AnimationCreeperTitanAttack3(EntityCreeperTitan entity) {
		super(entity);
		this.entity = entity;
	}
	...
	@Override
	public void tick() {
		if (this.entity.getTarget() != null && this.entity.getAnimationTick() < 32) {
