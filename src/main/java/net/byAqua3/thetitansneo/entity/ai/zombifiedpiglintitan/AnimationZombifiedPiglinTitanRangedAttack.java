...
public class AnimationZombifiedPiglinTitanRangedAttack extends AIAnimation {

	private EntityZombifiedPiglinTitan entity;

	public AnimationZombifiedPiglinTitanRangedAttack(EntityZombifiedPiglinTitan entity) {
		super(entity);
		this.entity = entity;
	}
