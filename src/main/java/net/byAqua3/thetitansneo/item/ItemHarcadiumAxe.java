...
public class ItemHarcadiumAxe extends AxeItem {
	...
	public ItemHarcadiumAxe(Properties properties) {
		super(TheTitansNeoTiers.HARCADIUM, properties.attributes(AxeItem.createAttributes(TheTitansNeoTiers.HARCADIUM, 49, -3.0F)));
	}
	...
	public boolean hurtEnemy(ItemStack stack, LivingEntity entity, LivingEntity attacker) {
		if (entity != null) {
			if (entity.getBbHeight() >= 6.0F || entity instanceof EntityTitan || !entity.onGround()) {
				...
				entity.hurt(entity.damageSources().mobAttack(attacker), 450.0F);
			}
		}
