...
public class ItemWitherSkeletonTitanSpawnEgg extends ItemTitanSpawnEgg {

	public ItemWitherSkeletonTitanSpawnEgg(Properties properties) {
		super(properties);
	}

	@Override
	public InteractionResult useOn(UseOnContext context) {
		EntityType<?> entityType = TheTitansNeoEntities.SKELETON_TITAN.get();
