...
public class ItemHarcadiumPickaxe extends PickaxeItem {

	public ItemHarcadiumPickaxe(Properties properties) {
		super(TheTitansNeoTiers.HARCADIUM, properties.attributes(PickaxeItem.createAttributes(TheTitansNeoTiers.HARCADIUM, 48, -2.8F)));
	}
	...
	public boolean hurtEnemy(ItemStack stack, LivingEntity entity, LivingEntity attacker) {
		if (entity != null) {
			if (entity.getBbHeight() >= 6.0F || entity instanceof EntityTitan || !entity.onGround()) {
				...
				entity.hurt(entity.damageSources().mobAttack(attacker), 400.0F);
			}
		}
